...
os.chdir("drive/My Drive/family photos");

base_dir = os.getcwd()

classnames=["kailasa","Srivalli","subramanyam","vedha","vaildate"];
...
path="/content/drive/My Drive/family photos/train/"
...
val_path="/content/drive/My Drive/family photos/val/"
